...
def mensagem(request, id):
    ...
    if id == 400 or id == 500:
        ...
        m = "Questionario guardado com sucesso"
        tipo = "success"
    elif id == 27:
        m = "Questionario criado e submetido para validação com sucesso"
        tipo = "success"
    elif id == 28:
        m = "Questionario validado com sucesso"
        tipo = "success"
    elif id == 29:
        m = "Questionario respondido com sucesso"
        tipo = "success"
    elif id == 30:
        m = "Questionario alterado e submetido para validação com sucesso"
        tipo = "success"
    elif id == 31:
        m = "Estado de Questionario já existe"
        tipo = "error"
    elif id == 32:
        m = "Descrição de Estado já existe para outro Estado"
        tipo = "error"
    elif id == 33:
        m = "Estado associado a um Questionario existente"
        tipo = "error"
    elif id == 34:
        m = "Estado de Questionario criado com sucesso"
        tipo = "success"
    elif id == 35:
        m = "Estado de Questionario alterado com sucesso"
        tipo = "success"
    elif id == 36:
        m = "Estado de Questionario eliminado com sucesso"
        tipo = "success"
    elif id == 37:
        m = "Tema já existe"
        tipo = "error"
    elif id == 38:
        m = "Descrição de Tema já existe para outro Tema"
        tipo = "error"
    elif id == 39:
        m = "Tema criado com sucesso"
        tipo = "success"
    elif id == 40:
        m = "Já existe um questionário publicado no ano letivo ativo"
        tipo = "error"
    elif id == 41:
        m = "As perguntas devem pertencer ao ano letivo ativo."
        tipo = "error"
    elif id == 42:
        m = "Questionario publicado com sucesso"
        tipo = "success"
    elif id == 43:
        m = "Impossivel eliminar. Perguntas já respondidas."
        tipo = "error"
    else:
