...
CREATE TABLE `ano_letivo` (
  ...
  `questionario_id` int(11) NULL, -- Added column to reference 'questionario'
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

ALTER TABLE `ano_letivo`  ADD CONSTRAINT fk_ano_letivo_questionario  FOREIGN KEY (questionario_id) REFERENCES questionario (id);

--
-- Extraindo dados da tabela `ano_letivo`
--

INSERT INTO `ano_letivo` (`ID`, `ano_letivo`, `dia_inicio`, `dia_fim`, `ativo`, `questionario_id`) VALUES
(1, '2023/24', '2023-09-19', '2024-07-21', 'S', null),
(2, '2022/23', '2022-09-19', '2023-07-21', 'N', 2),
(3, '2021/22', '2021-09-19', '2022-07-21', 'N', 1),
(4, '2020/21', '2020-09-19', '2021-07-21', 'N', null),
(5, '2019/20', '2019-09-19', '2020-07-21', 'N', 2),
(6, '2018/19', '2018-09-19', '2019-07-21', 'N', 1);
...
(7, 120, 52, 2, '2023-05-25', '2023-05-25 17:09:21', '2023-05-25 17:29:02', 4, 1, '2023-05-26', 'Teste Horario', 'Teste Horario', 1, 'a'),
(8, 120, 121, NULL, '2023-05-25', '2023-05-25 17:06:06', '2023-05-25 17:27:14', 4, 3, '2023-06-02', 'Teste sala', 'Teste sala', 1, 'b'),
...
CREATE TABLE pergunta (id int(11) NOT NULL AUTO_INCREMENT, conteudo varchar(255), questionario_id int(11), tema_id int(11), PRIMARY KEY (id));
CREATE TABLE questionario (id int(11) NOT NULL AUTO_INCREMENT, descricao varchar(255), assunto varchar(255), estado_id int(11), data_criacao date, data_submissao date, data_validacao date, PRIMARY KEY (id), comentarios varchar(255));
CREATE TABLE resposta (id int(11) NOT NULL AUTO_INCREMENT, conteudo_int int(11),conteudo_string varchar(255), pergunta_id int(11), PRIMARY KEY (id));
CREATE TABLE tipo_pergunta (id int(11) NOT NULL AUTO_INCREMENT, descricao varchar(255), PRIMARY KEY (id));
CREATE TABLE estado_questionario (id int(11) NOT NULL AUTO_INCREMENT, estado varchar(255), PRIMARY KEY (id));
CREATE TABLE tema_pergunta (id int(11) NOT NULL AUTO_INCREMENT, tema varchar(255), PRIMARY KEY (id));
CREATE TABLE utilizador_questionario (utilizadoruser_ptr_id int(11) NOT NULL, questionario_id int(11) NOT NULL, PRIMARY KEY (utilizadoruser_ptr_id, questionario_id));
ALTER TABLE utilizador_questionario ADD CONSTRAINT FKutilizador332382 FOREIGN KEY (questionario_id) REFERENCES questionario (id);
ALTER TABLE pergunta ADD CONSTRAINT questionario_ibfk FOREIGN KEY (questionario_id) REFERENCES questionario (id);
ALTER TABLE resposta ADD CONSTRAINT resposta_ibfk FOREIGN KEY (pergunta_id) REFERENCES pergunta (id);
ALTER TABLE questionario  ADD CONSTRAINT fk_estado_questionario  FOREIGN KEY (estado_id) REFERENCES estado_questionario (id);
ALTER TABLE pergunta  ADD CONSTRAINT fk_tema_pergunta  FOREIGN KEY (tema_id) REFERENCES tema_pergunta (id);
ALTER TABLE pergunta ADD COLUMN tipo_pergunta_id int(11), ADD FOREIGN KEY (tipo_pergunta_id) REFERENCES tipo_pergunta(id);
ALTER TABLE pergunta
ADD COLUMN valor_minimo INT(11) NULL,
ADD COLUMN significado_minimo VARCHAR(255) NULL,
ADD COLUMN valor_maximo INT(11) NULL,
ADD COLUMN significado_maximo VARCHAR(255) NULL;
ALTER TABLE estado_questionario ADD COLUMN descricao TEXT;
ALTER TABLE tema_pergunta ADD COLUMN descricao TEXT;
ALTER TABLE pergunta ADD COLUMN ano_letivo_id INT(11) NULL, ADD CONSTRAINT fk_pergunta_ano_letivo FOREIGN KEY (ano_letivo_id) REFERENCES ano_letivo (ID);
...
CREATE TABLE resposta_usuario (
    ...
    PRIMARY KEY (id),
    UNIQUE KEY (user_id, questionario_id)
);

ALTER TABLE resposta_usuario
ADD CONSTRAINT FK_resposta_usuario_user_id FOREIGN KEY (user_id) REFERENCES auth_user (id) ON DELETE CASCADE,
ADD CONSTRAINT FK_resposta_usuario_questionario_id FOREIGN KEY (questionario_id) REFERENCES questionario (id) ON DELETE CASCADE;





CREATE TABLE opcao_escolha_multipla (
    id INT(11) NOT NULL AUTO_INCREMENT,
    pergunta_id INT(11),
...
INSERT INTO estado_questionario (id, estado, descricao) VALUES
(1, 'Em Produção', 'Descricao estado'),
(2, 'Criado', 'Descricao estado'),
(3, 'Validado', 'Descricao estado'),
(4, 'Rejeitado', 'Descricao estado'),
(5, 'Publicado', 'Descricao estado'),
(6, 'Finalizado', 'Descricao estado'),
(7, 'Arquivado', 'Descricao estado');

INSERT INTO tema_pergunta (id, tema, descricao) VALUES
(1, 'teste1', 'Descricao tema'),
(2, 'teste2', 'Descricao tema'),
(3, 'teste3', 'Descricao tema'),
(4, 'teste4', 'Descricao tema'),
(5, 'Funcionario', 'Perguntas sobre funcionario'),
(6, 'Satisfação', 'Perguntas sobre satisfação'),
(7, 'Eficiencia', 'Perguntas sobre eficiencia do CP');

INSERT INTO tipo_pergunta (id, descricao) VALUES
(1, 'resposta curta'),
(2, 'resposta longa'),
(3, 'escolha múltipla'),
(4, 'escalar');
  ...
  INSERT INTO questionario (descricao, assunto, estado_id, data_criacao, data_submissao, data_validacao) VALUES
  ('Como você avalia a eficiência dos nossos serviços?', 'Avaliação de Serviço', 1, '2024-03-15', '2024-03-20', '2024-03-25'),
  ('Avaliação de desempenho dos funcionários', 'Desempenho', 2, '2024-03-15', '2024-03-22', '2024-03-23');
  -- ('Pesquisa de satisfação do cliente', 'Satisfação do Cliente', 5, '2022-03-16', '2022-03-23', '2022-03-31');
--  ('Pesquisa de satisfação do cliente', 'Satisfação do Cliente', 5, '2022-03-16', '2022-03-23', '2022-03-31');
--   ('Feedback sobre o produto', 'Feedback do Produto', 2, '2022-03-17', '2022-03-24', '2022-03-26'),
--   ('Pesquisa de bem-estar dos funcionários', 'Bem-estar dos Funcionários', 3, '2024-03-18', '2024-03-25', '2024-03-30'),
--   ('Eficiência do suporte ao cliente', 'Suporte ao Cliente', 7, '2023-03-19', '2023-03-26', '2023-03-31'),
--   ('Avaliação da experiência de compra online', 'Experiência Online', 6, '2024-04-01', '2024-04-05', '2024-04-10'),
-- ('Pesquisa sobre o uso de tecnologia no serviço', 'Tecnologia no Serviço', 2, '2023-04-02', '2023-04-06', '2023-04-21'),
-- ('Feedback sobre a facilidade de uso do nosso site', 'Usabilidade do Site', 4, '2024-04-03', '2024-04-07','2024-04-12'),
-- ('Opinião sobre políticas de trabalho remoto', 'Trabalho Remoto', 3, '2023-04-04', '2023-04-08', '2023-04-19'),
-- ('Estudo sobre a percepção da marca', 'Percepção da Marca', 6, '2024-04-14', '2024-04-19', '2024-04-24'),
-- ('Avaliação do ambiente de trabalho presencial', 'Ambiente de Trabalho', 2, '2022-04-15', '2022-04-20', '2022-04-25'),
-- ('Feedback sobre novas funcionalidades do produto', 'Novas Funcionalidades', 3, '2023-04-16', '2023-04-21', '2023-04-26'),
-- ('Avaliação do processo de suporte técnico', 'Suporte Técnico', 4, '2024-04-17', '2024-04-22', '2024-04-27');

INSERT INTO utilizador_questionario (utilizadoruser_ptr_id, questionario_id ) VALUES
(50,1),
(52,2),
(53,3);


INSERT INTO pergunta (questionario_id, tema_id, conteudo, tipo_pergunta_id,valor_minimo,valor_maximo,significado_minimo,significado_maximo, ano_letivo_id) VALUES
(1,5, 'Você está satisfeito com o tempo de resposta?', 4, 0,10,"Nada satisfeito","Muito satisfeito" ,1),
(1,6, 'Como você avalia a qualidade das respostas?', 2,NULL,NULL,NULL,NULL,1),
(2,5, 'Os funcionários foram profissionais e corteses?', 2,NULL,NULL,NULL,NULL,2),
(2,6, 'Você está satisfeito com o nível de conhecimento dos funcionários?', 1,NULL,NULL,NULL,NULL,3),
(3,6, 'Você recomendaria nossos serviços a outras pessoas?', 2,NULL,NULL,NULL,NULL,6),
(3,5, 'O que mais lhe agradou no serviço prestado?', 3,NULL,NULL,NULL,NULL,2),
(1,7, 'Houve algum problema durante o serviço?', 2,NULL,NULL,NULL,NULL,4),
(1,7, 'Em uma escala de 1 a 10, qual é o seu nível de satisfação geral?', 4,0,10,"Não recomendo","Recomendo muito",4),
(1,7, 'O que mais lhe agradou no serviço prestado?', 2,NULL,NULL,NULL,NULL,2),
(1,7, 'O que poderíamos fazer para melhorar nosso serviço?', 1,NULL,NULL,NULL,NULL,2),
(1,7, 'Onde gastou mais tempo?', 1,NULL,NULL,NULL,NULL,2),
(1,7, 'Quanto tempo demorou a sua utilização?', 2,NULL,NULL,NULL,NULL,2),
(1,7, 'O que achou sobre a eficiencia do programa?', 1,NULL,NULL,NULL,NULL,4);
-- (4,7, 'O que achou da experiencia?', 1),
-- (4,7, 'Recomendava a um amigo?', 4),
-- (4,7, 'O que podemos melhorar?', 2),
-- (4,7, 'Qual a ferramenta que gostou mais?', 3),
-- (1,7, 'Voltava a usar?', 1),
-- (3,7, 'O que poderíamos fazer para melhorar nosso serviço?', 2),
-- (4,5, 'Como você classificaria a qualidade do nosso produto?', 4),
-- (15,5, 'Como foi a experiencia?', 1),
-- (16,6, 'O que podemos melhorar', 1);


  INSERT INTO resposta (conteudo_string, pergunta_id) VALUES
  ("Sim",3),
  ("Sim",3),
  ("Sim",3),
  ("Sim",3),
  ...
  ("Muito lento",5),
  ("Lento",5),
  ("Não tenho permissão para alterar",5),
  ("Interface",5),
  ("Não",5),
  ("Não",5),
  ("Não",5),
  ...
  ("Exportar pedidos",11),
  ("Exportar pedidos",11),
  ("Download de ficheiros",11),
  ("Download de ficheiros",11),
  ("Download de ficheiros",11),
  ("Download de ficheiros",11),
  ("Procurar pedidos",11),
  ("Analisar estatistica",11),
  ("Analisar estatistica",11),
  ("2 horas",12),
  ("2 horas",12),
  ("2 horas e 30 min",12),
  ...
  INSERT INTO resposta (conteudo_int, pergunta_id) VALUES
  (5, 1),
  (5, 1),
  (7, 1),
  (9, 1),
...
INSERT INTO opcao_escolha_multipla(pergunta_id, texto_opcao) VALUES
(4, "Não"),
(4, "Mais ou menos"),
(4, "Sim"),
(8, "Rapidez"),
...
CREATE TABLE pedido_de_aluno (
    pedido_ptr_id INT(11) NOT NULL AUTO_INCREMENT,
    aluno_id INT(11) NOT NULL,
    PRIMARY KEY (pedido_ptr_id),
    FOREIGN KEY (pedido_ptr_id) REFERENCES pedido (ID),
    FOREIGN KEY (aluno_id) REFERENCES aluno (numero_aluno)
);

CREATE TABLE pedido_parecer (
    pedido_ptr_id INT(11) NOT NULL AUTO_INCREMENT,
    PRIMARY KEY (pedido_ptr_id),
    FOREIGN KEY (pedido_ptr_id) REFERENCES pedido (ID)
);

CREATE TABLE subpedido_aluno (
    ID INT(11) NOT NULL AUTO_INCREMENT,
    assunto VARCHAR(255),
    descricao VARCHAR(255),
    pedido_ptr_id INT(11) NOT NULL,
    tipo_subpedido_aluno_id INT(11) NOT NULL,
    PRIMARY KEY (ID),
    FOREIGN KEY (pedido_ptr_id) REFERENCES pedido_de_aluno (pedido_ptr_id)
        ON UPDATE RESTRICT ON DELETE RESTRICT,
    FOREIGN KEY (tipo_subpedido_aluno_id) REFERENCES tipo_subpedido_aluno (id)
        ON UPDATE RESTRICT ON DELETE RESTRICT
);

CREATE TABLE tipo_subpedido_aluno (
    id INT(11) NOT NULL AUTO_INCREMENT,
    nome VARCHAR(255),
    PRIMARY KEY (id)
);

INSERT INTO tipo_subpedido_aluno (id, nome) VALUES
(1, 'Justificação Falta'),
(2, 'Mudança de Turma'),
(3, 'Outro');


CREATE TABLE subpedido_parecer (
    ID INT(11) NOT NULL AUTO_INCREMENT,
    assunto VARCHAR(255) NOT NULL,
    descricao VARCHAR(255) NOT NULL,
    nome_investigador VARCHAR(255) NOT NULL,
    ficheiro VARCHAR(255) NOT NULL,
    pedido_ptr_id INT(11) NOT NULL,
    PRIMARY KEY (ID),
    FOREIGN KEY (pedido_ptr_id) REFERENCES pedido_parecer (pedido_ptr_id) ON UPDATE RESTRICT ON DELETE RESTRICT
);

-- Insert example data

INSERT INTO aluno (name, numero_aluno) VALUES ('John Doe', 51234);

INSERT INTO pedido (
    ID, DocenteUtilizadorID, FuncionarioUtilizadorID, identificador_id, 
    data_de_submissao, data_de_associacao, data_de_validacao, estado_id, tipo_id, 
    data_de_alvo, assunto, informacoes, anoletivoid, comentarios
) VALUES (
    15, 120, NULL, 1, '2024-07-01', NULL, NULL, 1, 6, '2024-07-03', 
    'Pedido para Aluno', 'Detalhes do pedido para aluno', 1, 'Nenhum comentário específico'
);
...
INSERT INTO pedido (
    ...
    16, 120, NULL, 1, '2024-07-09', NULL, NULL, 1, 6, '2024-07-14', 
    'Pedido para Aluno2', 'Detalhes do pedido para aluno2', 1, 'Nenhum comentário específico'
);
...
INSERT INTO pedido (
    ...
    13, 120, NULL, 1, '2023-05-23', NULL, NULL, 1, 5, '2023-06-02', 
    'Pedido para Parecer', 'Detalhes do pedido para parecer', 1, 'Nenhum comentário específico'
);
...
INSERT INTO pedido (
    ...
    14, 120, NULL, 1, '2023-05-23', NULL, NULL, 1, 5, '2023-06-02', 
    'Pedido para Parecer2', 'Detalhes do pedido para parecer2', 1, 'Nenhum comentário específico2'
);

INSERT INTO sala(ID, Estado_Sala_id, Nome_Instituicao_id, Desc_Edificio_id, Desc_Sala, Des_Categoria_id, Tipo_sala_id, Lotacao_Presencial_Sala, ano_letivo_id )VALUES(
  2, 1, 1, 1, 'sala informatica', 1, 1, 30, 2025);
INSERT INTO sala (ID, Estado_Sala_id, Nome_Instituicao_id, Desc_Edificio_id, Desc_Sala, Des_Categoria_id, Tipo_sala_id, Lotacao_Presencial_Sala, ano_letivo_id) VALUES (
  3, 1, 1, 1, '2.53', 2, 2, 50, 2025);
INSERT INTO sala (ID, Estado_Sala_id, Nome_Instituicao_id, Desc_Edificio_id, Desc_Sala, Des_Categoria_id, Tipo_sala_id, Lotacao_Presencial_Sala, ano_letivo_id) VALUES (
  4, 1, 1, 2, '2.60', 3, 3, 24, 2025);
INSERT INTO sala (ID, Estado_Sala_id, Nome_Instituicao_id, Desc_Edificio_id, Desc_Sala, Des_Categoria_id, Tipo_sala_id, Lotacao_Presencial_Sala, ano_letivo_id) VALUES (
  5, 1, 1, 2, '2.55', 2, 4, 20, 2025);




-- Inserção em pedido_de_aluno com um pedido específico
INSERT INTO pedido_de_aluno (pedido_ptr_id, aluno_id) VALUES (15, 51234);
INSERT INTO subpedido_aluno (ID, assunto, descricao, pedido_ptr_id, tipo_subpedido_aluno_id) VALUES (105, 'Assunto1', 'Descrição1', 15,1);
INSERT INTO subpedido_aluno (ID, assunto, descricao, pedido_ptr_id, tipo_subpedido_aluno_id) VALUES (106, 'Assunto22', 'Descrição22', 15,2);
INSERT INTO subpedido_aluno (ID, assunto, descricao, pedido_ptr_id, tipo_subpedido_aluno_id) VALUES (107, 'Assunto33', 'Descrição33', 15,3);
INSERT INTO pedido_de_aluno (pedido_ptr_id, aluno_id) VALUES (16, 51234);
INSERT INTO subpedido_aluno (ID, assunto, descricao, pedido_ptr_id, tipo_subpedido_aluno_id) VALUES (108, 'isto_e_assunto', 'isto_e_descricao', 16,1);

-- Inserção em pedido_parecer com um pedido diferente
INSERT INTO pedido_parecer (pedido_ptr_id) VALUES (13);
INSERT INTO pedido_parecer (pedido_ptr_id) VALUES (14);


-- Inserção em subpedido_parecer
INSERT INTO subpedido_parecer (ID, assunto, descricao, nome_investigador,ficheiro, pedido_ptr_id) VALUES (102, 'Subpedido para Parecer', 'Descrição do Subpedido para Parecer', 'Jacinto', 'relatorio_parecer.pdf', 13);
INSERT INTO subpedido_parecer (ID, assunto, descricao, nome_investigador,ficheiro, pedido_ptr_id) VALUES (103, 'Subpedido para Parecer2', 'Descrição do Subpedido para Parecer2', 'Jacinto2', 'relatorio_parecer.pdf2', 13);
INSERT INTO subpedido_parecer (ID, assunto, descricao, nome_investigador,ficheiro, pedido_ptr_id) VALUES (104, 'Subpedido para Parecer2', 'Descrição do Subpedido para Parecer2', 'Jacinto2', 'relatorio_parecer.pdf2', 14);
