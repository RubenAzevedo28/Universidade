...
class PedidosTable(django_tables.Table):
    ...
    def render_acoes(self, record):
        ...
        if record.tipo.id == 1:
            ...
            primeiro_botao = f"""
                    <a data-tooltip="Consultar" href="consultarpedidoparecer/{record.id}">
                        <span class="icon">
                            <i class="mdi mdi-eye mdi-24px" style="color: #32CD32" ></i>
                        </span>
                    </a>
            ...
            primeiro_botao = f"""
                    <a data-tooltip="Consultar" href="consultarpedidoaluno/{record.id}">
                        <span class="icon">
                            <i class="mdi mdi-eye mdi-24px" style="color: #32CD32" ></i>
                        </span>
                    </a>
        ...
        if user.groups.filter(name = "Docente").exists():
            if record.estado_0.id == 1:
                if record.tipo.id == 1:
                    ...
                    segundo_botao = f""" <a data-tooltip="Editar" href="editarpedidoparecer/{record.id}"  class="icon">
                        <i class="mdi mdi-circle-edit-outline mdi-24px"></i>
                    </a>
                    """
                    terceiro_botao = f"""<a  data-tooltip="Eliminar" href="eliminarpedidoparecer/{record.id}" class="icon has-text-danger" >
                        <i class="mdi mdi-trash-can mdi-24px"></i>
                    </a>
                    """
                elif record.tipo.id == 6:
                    segundo_botao = f""" <a data-tooltip="Editar" href="editarpedidoaluno/{record.id}"  class="icon">
                        <i class="mdi mdi-circle-edit-outline mdi-24px"></i>
                    </a>
                    """
                    terceiro_botao = f"""<a  data-tooltip="Eliminar" href="eliminarpedidoaluno/{record.id}" class="icon has-text-danger" >
                        <i class="mdi mdi-trash-can mdi-24px"></i>
                    </a>
                    """
