...
Este projeto consiste numa reinterpretação do clássico **Space Invaders**, desenvolvido no âmbito da unidade curricular de **Programação Orientada por Objetos (POO)** da **Universidade do Algarve**.
